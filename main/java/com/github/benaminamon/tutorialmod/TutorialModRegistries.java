...
import init.TutorialArmorMaterials;
import init.TutorialBlocks;
import init.TutorialEntities;
import init.TutorialItems;
import init.TutorialToolMaterials;
...
public class TutorialModRegistries
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event)
	{
		...
		(
				...
				TutorialItems.tutorial_axe = new AxeItem(TutorialToolMaterials.tutorial, -1.0f, 5.0f, new Item.Properties().group(TUTORIAL)).setRegistryName(location("tutorial_axe")),
				...
				TutorialItems.tutorial_pickaxe = new PickaxeItem(TutorialToolMaterials.tutorial, -2, 6.0f, new Item.Properties().group(TUTORIAL)).setRegistryName(location("tutorial_pickaxe")),
				TutorialItems.tutorial_shovel = new ShovelItem(TutorialToolMaterials.tutorial, -2.0f, 6.0f, new Item.Properties().group(TUTORIAL)).setRegistryName(location("tutorial_shovel")),
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event)
	{
		event.getRegistry().registerAll
		(
				TutorialBlocks.tutorial_block = new Block(Block.Properties.create(Material.IRON).hardnessAndResistance(2.0f, 3.0f).lightValue(5).sound(SoundType.STONE)).setRegistryName(location("tutorial_block")),
				
				TutorialBlocks.tutorial_ore = new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0f, 3.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("tutorial_ore")),
				TutorialBlocks.tutorial_ore_nether = new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0f, 3.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("tutorial_ore_nether")),
				TutorialBlocks.tutorial_ore_end = new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0f, 3.0f).lightValue(0).sound(SoundType.STONE)).setRegistryName(location("tutorial_ore_end"))
		);
